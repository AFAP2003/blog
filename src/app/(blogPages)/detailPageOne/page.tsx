...
import { NewsOne } from "../../components/paragraphs";
...
export default function detailPageOne(){
    return(
        <>
            <Navbar/>
         <DetailBanner image="https://e3.365dm.com/24/12/1600x900/skynews-artemis-nasa_6768058.jpg?20241206091047" title="NASA delays flagship moon landing plans once again "/>
